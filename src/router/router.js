...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "garage-detail", element: <TruckDetails /> },
      { path: "entretien-garage", element: <TruckMaintenances /> },
      { path: "documents-garage", element: <TruckAttachments /> },
      { path: "trajets-garage", element: <TruckTrips /> },
      { path: "bilan-carbone-garage", element: <CarbonBalance /> },
