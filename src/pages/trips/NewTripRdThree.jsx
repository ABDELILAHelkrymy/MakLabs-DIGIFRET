...
import { ChevronLeftIcon, PlusIcon, ChartBarIcon, ArrowUpTrayIcon, ArrowDownTrayIcon } from "@heroicons/react/24/solid";
import { Card, CardBody, Stepper, Step, Input, Button } from "@material-tailwind/react";
        ...
        <div className="explore">
            <Card>
                <CardBody>
                    ...
                    <div className="mb-3">
                        <div className="flex">
                            <ArrowDownTrayIcon height="25px" width="25px" className="mr-3"/>
                    ...
                    <div className="">
                        <div className="list-element">
                            <div className="pt-5 pb-5"><Input name="nom" label="Prix total"/></div>
                            <div className="pt-5 pb-5"><Input name="tel" label="poid total en T (Ton)" /></div>
                            <div className="pt-5 pb-5"><Input name="email" label="Nombre des palettes" /></div>
                            <div className="pt-5 pb-5"><Input name="adresse" label="Camion" /></div>
                            <div className="pt-5 pb-5"><CalendarElement /></div>
                        </div>
                    </div>
