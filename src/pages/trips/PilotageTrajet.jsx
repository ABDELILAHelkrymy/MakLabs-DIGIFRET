...
import { ChevronLeftIcon, PlusIcon, ArrowUpRightIcon, HeartIcon, StarIcon} from "@heroicons/react/24/solid";
    ...
    <>
        ...
        <div className="explore">
           ...
           <CardBody>
            ...
            <div className="mb-2">
              <div className="flex justify-center"><Chart {...chartConfig2}/></div>
                <div className="">
                   <div className="text-right">prix cible</div>
                   <div className="flex items-center justify-end">
            ...
            <div className="flex justify-between border-t-2 pt-5 pb-5">
              <HeartIcon height="25px" width="25px" fill="none" stroke="currentColor"/>
              <HeartIcon height="25px" width="25px" fill="none" stroke="currentColor"/>
            ...
            <div className="flex justify-between border-t-2 pt-5">
              <StarIcon height="25px" width="25px" fill="none" stroke="currentColor"/>
