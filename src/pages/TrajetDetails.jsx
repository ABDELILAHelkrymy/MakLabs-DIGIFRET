  ...
  return (
    <div className="bg-white p-5">
        <div className="flex justify-between mb-5">
            <div className=""><ChevronLeftIcon  width="20px" height="20px" onClick={()=>{navigate('/trajets')}} /></div>
        ...
        <div className="carteMap w-full overflow-hidden mb-5">
          <iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d1679119.007290524!2d-7.869855156455536!3d34.71705009221249!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e6!4m5!1s0xd0c9b86ce183b5b%3A0xb3593ae869541a11!2sTanger%20Med%2C%20N16!3m2!1d35.879556199999996!2d-5.5136612!4m5!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd3!2sCasablanca!3m2!1d33.5731104!2d-7.5898433999999995!5e0!3m2!1sfr!2sma!4v1707590134438!5m2!1sfr!2sma" width="480" height="200" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div className="trajet-detail flex justify-between">
          <div>
            <div className="flex items-center">
              <IdentificationIcon width="20px" height="20px" className="mr-2"/>
        ...
        <div className="trajet-detail flex justify-between">
          <div>
            <div className="flex items-center">
              <ArrowDownTrayIcon width="20px" height="20px" className="mr-2"/>
