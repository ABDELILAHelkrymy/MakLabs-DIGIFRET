...
import { ChevronLeftIcon, UserIcon, ArrowUpTrayIcon, ArrowDownTrayIcon, CalendarDaysIcon, MapIcon, XMarkIcon } from "@heroicons/react/24/solid";
import {
    Card,
    CardBody,
    Button,
...
return (
    ...
    <div className="flex justify-between p-5 bg-white text-gray-700">
            ...
            <XMarkIcon width="25px" height="25px" fill="#000" onClick={() => {navigate('/entretien-garage')}}/>
        </div>
        {/* Page Content  */}
           ...
           <Card>
                <CardBody>
                    ...
                    <div className="flex flex-col">
                        <div className="mb-5"><CalendarElement /></div>
                        <div className="mb-5">
                        ...
                        <div className="mb-5"><Input label="Total TTC DHS" /></div>
                    </div>
