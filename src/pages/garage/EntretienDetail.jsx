...
import { ChevronLeftIcon, ArrowUpTrayIcon, CalendarDaysIcon, PencilSquareIcon, MapIcon } from "@heroicons/react/24/solid";
...
const EntretienDetail = () => {
    ...
    return (
        ...
        <div className="flex justify-between p-5 bg-white text-gray-700">
            ...
            <PencilSquareIcon width="25px" height="25px" fill="#2eaa35" onClick={() => {navigate('/nouvelle-tache-entretien')}}/>
        </div>
        {/* Page Content  */}
