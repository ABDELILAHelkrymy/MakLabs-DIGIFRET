...
import { ChevronLeftIcon, ArrowUpTrayIcon, StarIcon } from "@heroicons/react/24/solid";
...
const Documents = () => {
    ...
    return (
        ...
        <div className="flex justify-between p-5 bg-white text-gray-700">
            ...
            <ArrowUpTrayIcon width="25px" height="25px" fill="#2eaa35" onClick={() => {navigate('/nouvelle-tache-entretien')}}/>
        </div>
        {/* Page Content  */}
        <div className="explore">
            <Card className="overflow-hidden">
                <CardBody className="text-center">
                    <div className="flex p-3 border-b-[2px] items-center" onClick={() => {navigate('/entretien-garage-detail')}}>
                        <div className="w-1/4 text-left">21/10</div>
                        <div className="w-1/2 text-left">Facture 20220405</div>
                        <div className="w-1/4 flex justify-end"><StarIcon fill="none" stroke="currentColor" strokeWidth={1.5} height="25px" width="25px" /></div>
                    </div>
                    <div className="flex p-3 border-b-[2px] items-center">
                        ...
                        <div className="w-1/4 flex justify-end"><StarIcon height="25px" width="25px" /></div>
                    </div>
                    <div className="flex p-3 border-b-[2px] items-center">
                        <div className="w-1/4 text-left">21/10</div>
