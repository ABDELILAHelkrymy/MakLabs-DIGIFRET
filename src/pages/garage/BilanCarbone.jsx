...
import { ChevronLeftIcon, ArrowUpTrayIcon, ArrowDownTrayIcon, ShoppingCartIcon, BuildingOfficeIcon, PuzzlePieceIcon, SignalIcon } from "@heroicons/react/24/solid";
            ...
            <Card>
                <CardBody>
                    ...
                    <div className="flex items-center mt-4">
                        <div className="w-1/2"><Chart {...chartConfig}/></div>
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-1/2">
                            <div className="flex items-center p-5">
                                <ShoppingCartIcon  width="30px" height="30px" className="mr-3"/>
                        ...
                        <div className="w-1/2">
                            <div className="flex items-center p-5">
                                <BuildingOfficeIcon  width="30px" height="30px" className="mr-3"/>
                                <div className="flex flex-col">
                                    <div>Bureaux</div>
                                    <div>12%</div>
                                </div>
                        ...
                        <div className="w-1/2">
                            <div className="flex items-center p-5">
                                <PuzzlePieceIcon  width="30px" height="30px" className="mr-3"/>
                                <div className="flex flex-col">
                                    <div>Autres</div>
                                    <div>3%</div>
                                </div>
                    ...
                    <Button fullWidth className="flex justify-center items-center gap-3 bg-purple-400">
