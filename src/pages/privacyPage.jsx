  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Digifret, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Digifret.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Digifret, accessible from{" "}
            <a
              href="https://mak-labs-digifrit.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://mak-labs-digifrit.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: abdelilahelkrymy@gmail.com</li>
      </ul>
    </div>
  );
};
