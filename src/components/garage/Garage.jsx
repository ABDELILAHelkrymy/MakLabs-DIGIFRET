...
import { TruckIcon, CalendarDaysIcon, UserIcon, ArchiveBoxIcon, ArrowsUpDownIcon, ChevronDoubleRightIcon, PlayIcon, PlayPauseIcon, PlayCircleIcon, PauseCircleIcon } from "@heroicons/react/24/solid";
import {
    Card,
    CardBody,
    CardFooter,
            ...
            <CardBody>
                <div className="garage flex justify-between text-xs">
                    ...
                    <div className="actions flex flex-col justify-between w-1/2 items-end ">
                        ...
                        <div className="text-right"><span>Localisé il y a 3 jours,<br/> à Casablanca</span></div>
                        <div className="detail-trajet"><ChevronDoubleRightIcon width="20px" height="20px" onClick={() => {navigate('/garage-detail')}}/></div>
                    </div>
                </div>
            </CardBody>
        </Card>
